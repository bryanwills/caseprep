  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-target",
  {
    variants: {
      variant: {
        ...
        // Legal industry specific variants
        legal: "bg-legal-primary text-white hover:bg-legal-primary/90",
        success: "bg-status-completed text-white hover:bg-status-completed/90",
        warning: "bg-status-processing text-white hover:bg-status-processing/90",
      ...
      size: {
        ...
        "mobile-sm": "h-12 px-4 text-base", // Larger touch target
        "mobile-lg": "h-14 px-6 text-lg", // Even larger for primary actions
      },
    },
    defaultVariants: {
      variant: "default",
